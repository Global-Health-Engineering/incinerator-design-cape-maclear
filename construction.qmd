...
![Figure 5: Scheme visualizing the nail placement and the string to start setting up the foundation of the base.](img/05-foundation-measurements.png).
...
Once all the parts are set in place and dry, a second layer of bricks is put in place. It is attached to the first one to confer more robustness to the whole structure.
